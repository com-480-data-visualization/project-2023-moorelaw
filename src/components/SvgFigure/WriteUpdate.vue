    ...
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="401px"
        ...
        <g>
            ...
            <foreignObject x="60" y="38" width="60" height="20" style="font-size: center;">
                <input type="text" pattern="[0-9]" v-model="input_data" @input="onDataUpdate()" />
            </foreignObject>
            ...
            <rect x="280" y="40" width="60" height="20" fill="rgb(255, 255, 255)" stroke="rgb(0, 0, 0)"
                pointer-events="all" />
            <g fill="rgb(0, 0, 0)" text-anchor="middle" font-size="12px"><text x="309.5" y="54.5">0x100</text></g>
            <rect x="340" y="40" width="60" height="20" fill="rgb(255, 255, 255)" stroke="rgb(0, 0, 0)"
                pointer-events="all" />
            <g fill="rgb(0, 0, 0)" text-anchor="middle" font-size="12px"><text ref="core2_data" x="369.5" y="54.5">5</text>
            </g>
            ...
            <rect x="0" y="280" width="60" height="20" fill="rgb(255, 255, 255)" stroke="rgb(0, 0, 0)"
                pointer-events="all" />
            <g fill="rgb(0, 0, 0)" text-anchor="middle" font-size="12px"><text x="29.5" y="294.5">0x100</text></g>
            <rect x="60" y="280" width="60" height="20" fill="rgb(255, 255, 255)" stroke="rgb(0, 0, 0)"
                pointer-events="all" />
            <g fill="rgb(0, 0, 0)" text-anchor="middle" font-size="12px"><text ref="core3_data" x="89.5" y="294.5">5</text>
            </g>
...
const core2_data = ref(null);
const core3_data = ref(null);
...
const onDataUpdate = () => {
    ...
    const request_animation = async (index: string) => {
        ...
        [core2_data, core3_data].forEach((el) => d3.select(el.value).style("fill", "red").text(input_data.value));
        ...
        replies[index][0].attr("stroke-dashoffset", requests[index][0].attr("stroke-dasharray")).style("opacity", 1);
        replies[index][1].attr("stroke-dashoffset", requests[index][1].attr("stroke-dasharray")).style("opacity", 1);

        [core2_data, core3_data].forEach((el) => d3.select(el.value).style("fill", "black"));
    };
