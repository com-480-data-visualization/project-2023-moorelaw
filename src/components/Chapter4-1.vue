<template>
    <h1>Period 2: Step to Multiple Cores</h1>
    <p>(2005 to Now)</p>
    <div class="text-justify mx-40">
        <p class="pt-10">Around 2005, due to the limit of the power consumption, it is hard to
        ...
        <p class="pt-10">The main challenge of designing multi-core processors come from the
            following aspects: </p>
        <ul class="pt-1">
        ...
        <p class="pt-10">Please move to the next slide to see more details. </p>
    </div>
</template>